...
Partial Class MedicamentosDelete
    ...
    Private Sub InitializeComponent()
        ...
        btn_Borrar.Location = New Point(41, 92)
        ...
        btn_Cancelar.Location = New Point(159, 92)
        ...
        Label1.TabIndex = 29
        Label1.Text = "¿Deseas borrar este medicamento?"
        ' 
        ' MedicamentosDelete
        ' 
