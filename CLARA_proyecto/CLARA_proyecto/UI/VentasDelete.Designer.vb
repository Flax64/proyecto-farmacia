...
Partial Class VentasDelete
    ...
    Private Sub InitializeComponent()
        ...
        Label1.TabIndex = 2
        Label1.Text = "¿Deseas borrar esta venta?"
        ' 
        ' Label2
        ' 
        ...
        btn_cancelar.Location = New Point(157, 105)
        ...
        btn_borrar.Location = New Point(39, 105)
