...
Partial Class EmpleadosDelete
    ...
    Private Sub InitializeComponent()
        ...
        btn_borrar.Location = New Point(43, 125)
        ...
        btn_cancelar.Location = New Point(161, 125)
        ...
        Label1.TabIndex = 29
        Label1.Text = "¿Deseas borrar este empleado?"
        ' 
        ' EmpleadosDelete
        ' 
